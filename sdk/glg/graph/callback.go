...
type GraphCallback interface {
	HandleGraphStart(ctx context.Context, initialState []llms.MessageContent)
	HandleGraphEnd(ctx context.Context, finalState []llms.MessageContent)
...
func (callback *SimpleCallback) HandleGraphStart(ctx context.Context, initialState []llms.MessageContent) {
}
func (callback *SimpleCallback) HandleGraphEnd(ctx context.Context, finalState []llms.MessageContent) {
}
